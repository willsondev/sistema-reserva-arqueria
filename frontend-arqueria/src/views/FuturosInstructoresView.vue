<template>
  <div class="container mx-auto p-4">
    <h1 class="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight tracking-tight text-gray-900 bg-gradient-to-r from-green-400 to-blue-500 text-transparent bg-clip-text text-center">Proximos Instructores de Arquería</h1>
  ...
  data() {
    return {
      ...
      imagenesInstructores: [
          ...
          '../../public/img/img-futuros-profesores/2.jpeg',
          '../../public/img/img-futuros-profesores/3.jpeg',
          '../../public/img/img-futuros-profesores/4.jpeg',
          '../../public/img/img-futuros-profesores/5.jpeg',
          '../../public/img/img-futuros-profesores/6.jpeg',
          '../../public/img/img-futuros-profesores/7.jpeg',
          '../../public/img/img-futuros-profesores/8.jpeg',
